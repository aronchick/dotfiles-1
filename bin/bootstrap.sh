...
echo 'Dotfiles - Justin Garrison'
# forked from https://github.com/cowboy/dotfiles/blob/master/bin/dotfiles
...
https://github.com/rothgar/dotfiles

Copyright (c) 2013 Justin Garrison
...
if [[ ! -d ~/.dotfiles ]]; then
  ...
  git clone --recursive git://github.com/rothgar/dotfiles.git ~/.dotfiles
  cd ~/.dotfiles
else
